json.extract! request, :id, :request, :item, :model, :plan, :contract, :contract_type,
...
:email, :company, :deptname, :start_date, :end_date, :closed_at, :user_id, :created_at, :updated_at
